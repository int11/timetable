    ...
    const initialData = [
        {
            ...
            "color": "#ffe066",
            "수업": [
                { "이름": "컴퓨터비전기초와응용", "시간표": "월[DD]13:30-14:45,수[CC]12:00-13:15" },
                { "이름": "창의적융합디자인", "시간표": "금[EE]15:00-16:15,금[FF]16:30-17:45" }
            ]
        },
        {
            "이름": "손유진",
            "color": "#ffb8b8",
            "수업": [
                { "이름": "지속가능IT기술세미나", "시간표": "수[09]17:00-17:50" },
                { "이름": "온디바이스AI", "시간표": "목[EE]15:00-16:15,목[FF]16:30-17:45" },
                { "이름": "기계학습코너스톤", "시간표": "화[DD]13:30-14:45,목[CC]12:00-13:15" }
            ]
        },
        {
            "이름": "이인재",
            "color": "#74b9ff",
            "수업": [
                { "이름": "현대인공지능", "시간표": "화[EE]15:00-16:15,목[FF]16:30-17:45" },
                { "이름": "생성형AI이론및코딩", "시간표": "화[CC]12:00-13:15,목[DD]13:30-14:45" }
            ]
        },
    ];
